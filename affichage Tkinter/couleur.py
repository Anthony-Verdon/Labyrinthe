...
def changementCouleur(nombre,longueurLabyrinthe):
    ...
    if nombre[0]==0 and nombre[1]!=0 and nombre[2]==255:
        if nombre[1]-15//(longueurLabyrinthe//15)<0:
            nombre[1]=0
        else:
            nombre[1]-=15//(longueurLabyrinthe//15)
    elif nombre[0]!=255 and nombre[1]==0 and nombre[2]==255:
        if nombre[0]+15//(longueurLabyrinthe//15)>255:
            nombre[0]=255
        else:
            nombre[0]+=15//(longueurLabyrinthe//15)
    elif nombre[0]==255 and nombre[1]!=255 and nombre[2]==0:
        if nombre[1]+15//(longueurLabyrinthe//15)>255:
            nombre[1]=255
        else:
            nombre[1]+=15//(longueurLabyrinthe//15)
    elif nombre[0]==255 and nombre[1]==0 and nombre[2]!=0:
        if nombre[2]-15//(longueurLabyrinthe//15)<0:
            nombre[2]=0
        else:
            nombre[2]-=15//(longueurLabyrinthe//15)
