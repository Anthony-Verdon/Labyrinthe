...
class Jeu:
    ...
    def lancerJeu(self,longueurLabyrinthe,delai):
        ...
        self.compteurCassageMur=round(longueurLabyrinthe/2.5-1)   
    ...
    def resolutionLabyrinthe(self,coordonneeX,coordonneeY,nombre):
        ...
        if not(nombre in self.dico):
            print(nombre)
            self.dico[nombre]=self.start=couleurResolution(self.start,len(self._tableau))  
